...
class VkAuthorizationService implements VkAuthorizationServiceInterface
{
    ...
    protected const AUTHORIZATION_DIALOG_URL_TEMPLATE = "https://oauth.vk.com/authorize?client_id=%u&display=%s&redirect_uri=%s&response_type=code&v=5.76";
    protected const REDIRECT_URI = "http://localhost:8080/authorization/vk/done";
    protected const ACCESS_TOKEN_URL = "https://oauth.vk.com/access_token?client_id=%u&client_secret=%s&redirect_uri=%s&code=%s";

    protected $appId;
    protected $authDialogDisplayType = 'popup';
    protected $authCode;
    ...
    {
        return $this->authorizationDialogUrl($this->appId, $this->authDialogDisplayType, self::REDIRECT_URI);
    }
    ...
    public function getAccessToken($auth_code = null)
    {
        ...
        $access_token_url = $this->accessTokenUrl($this->appId, self::CLIENT_SECRET_KEY,
